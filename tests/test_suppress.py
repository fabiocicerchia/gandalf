...
def test_fingerprint_line_insensitive():
...
def test_rule_matching_and_wildcards():
    ...
    assert out.outcome is GateOutcome.PASS and out.findings == []
    # path glob
...
def test_partial_is_never_worse():
...
def test_inactive_suppressor_is_identity():
    r = _res()
