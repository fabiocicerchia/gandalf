...
const findingsOf = (name: string, messages: string[]): Finding[] => normalizeGate(gate(name, messages), "/repo");
  ...
  describe("memoization", () => {
    ...
    it("re-derives after every kind of mutation", () => {
      ...
      const changes: [string, () => void][] = [
        ...
        ["setFile", () => store.setFile(folder as never, "/repo/app.py", snapshot([gate("ruff", ["c"])]), 1)],
